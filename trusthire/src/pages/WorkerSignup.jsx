        ...
        <div className="bg-white rounded-xl shadow-2xl p-8 space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-gray-600">
              {step === 1 ? 'Create your worker account' : 'Verify your email'}
            </p>
          </div>
            ...
            <form onSubmit={handleOTPVerification} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  maxLength="6"
                  pattern="[0-9]{6}"
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition text-center text-2xl tracking-widest"
                />
              </div>
          ...
          <div className="space-y-2 border-t pt-4">
            <button
              ...
              className="w-full text-blue-600 hover:text-blue-700 font-semibold py-2 transition text-sm"
            >
